...
| 영역 | 내용 |
|---|---|
| **강의실** | 9개 강좌 · 51차시. 강의계획서 + 주차별 목차, 차시 하나에 그 단원의 전부 |
...
| **연습 랩** | 보이싱 랩(12키 자동 순환) · 진행 분석 + 반주 · 코드 탐색기 · 청음 훈련 · 연습 설계 · 메트로놈(2·4박) |
...
화면은 대학 LMS 구조를 따른다 — **강의실 → 강좌(강의계획서 + 주차별 목차) → 차시**.
메뉴는 네 개뿐이다(강의실 · 연습 랩 · 자료실 · 내 진도). 차시 하나에 학습목표·개념·
교수법·드릴·곡·필청·영상·평가·검수가 번호 순서로 들어가므로 학습 중에 메뉴를
돌아다닐 일이 없다.
